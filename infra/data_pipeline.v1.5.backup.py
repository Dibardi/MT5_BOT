# ==============================================
# MT5_BOT — data_pipeline.py (versión 1.5)
# Última actualización: 2025-11-11
# ==============================================
# Corrige la advertencia de Pandas al leer fechas con parse_dates.
# Ahora usa un formato explícito '%Y-%m-%d' para asegurar consistencia y eliminar warnings.
# ----------------------------------------------
...
def load_data():
    ...
    for f in files:
        try:
            df = pd.read_csv(f, index_col=0, parse_dates=[0], date_parser=date_parser)
