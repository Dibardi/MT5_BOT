# ==============================================
# MT5_BOT — data_pipeline.py (versión 1.4)
# Última actualización: 2025-11-11
# ==============================================
# Corrige el manejo del índice temporal al guardar metadatos.
# Evita errores 'str' object has no attribute 'date' y garantiza fechas válidas.
# ----------------------------------------------
...
def save_processed_data(df: pd.DataFrame):
    ...
    # --- Corrección de tipo datetime en índice ---
